 ...
 */
export function render(element: React.ReactNode, target: HTMLImageElement, apiKey: string) {
  let root = instances.get(target)

  if (!root) {
    const containerObject = new Container({ containerElement: target, apiKey })
  ...
  reconciler.injectIntoDevTools({
    ...
    version: version,
    rendererPackageName: 'react-dalle-fiber'
  })
}
